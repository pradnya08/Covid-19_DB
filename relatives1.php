<?php
 ...
 $con1=mysqli_connect('localhost','root','','covid19_db');
     if(isset($_POST['send']))
     {
             ...
             $num1=$_POST['num'];
                 echo $query1;
                header("location:relatives2.php?patid=".$patient."&num=".$num1);
     }
...
<html>
  <head>
    ...
    <title>COVID19 Relatives Page</title>
              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">COVID-19 Database </h3>
                  </div>
                  <div class="card-body">
                    <form class="form-horizontal" action="relatives1.php" method="POST">
                     
                    <input type="hidden" name="patID" id="patID" value="<?php echo $patientID?>" >
                     
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-md-3 form-control-label">Enter number of relatives you met recently</label>
                        <div class="col-md-3">
                          <input type="text" placeholder="num" name="num"  id="num" class="form-control" >
                        </div>
                        <br>
                        <br>
