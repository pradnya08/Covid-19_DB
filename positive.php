...
//echo $patientID;
    ...
    if(isset($_POST['send']))
    {
        $con=mysqli_connect('localhost','root','','covid19_db');
            ...
            $query="UPDATE patient SET height='$height1',weight='$weight1' WHERE patient_id='$patient'";
            if(mysqli_query($con,$query))
            {
                
                header("location:services.php?patid=".$patient);
            }
              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    ...
                    <h3 class="h6 text-uppercase mb-0">You are displaying the symptoms of COVID19</h3><br>
                    <h3 class="h6 text-uppercase mb-0">Additional Information</h3>
                  </div>
                  <div class="card-body">
                    <form class="form-horizontal" action="positive.php" method="POST">
                     
                    <input type="hidden" name="patID" id="patID" value="<?php echo $patientID?>" >
                     
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-md-3 form-control-label">Enter your height</label>
                        <div class="col-md-3">
                          <input type="text" placeholder="height (in cm)" name="height"  id="height" class="form-control" >
                        </div>
                        <br>
                        <br>
                        <label class="col-md-3 form-control-label">Enter your weight</label>
                        <div class="col-md-3">
